...
# NOTE - There is a distinction between 'transmitted commands', and 'processed and responded commands'.
# It's unclear whether all of these commands are commands we send to the machine, and if not, it's unclear
# how we get any information out at all.

# NOTE - These are all MEDIBUS commands, which are standard across all of Draeger's ventilators. Not sure
# whether to put these in each 'device' separately.
evita.commands = {
        'NOP': {
                'code': '0x30',
